...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-surface-50 via-white to-primary-50/30 dark:from-surface-950 dark:via-surface-900 dark:to-primary-950/20 transition-colors duration-300">
      {/* Left: Branding */}
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden gradient-primary">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute bottom-20 -right-20 w-[500px] h-[500px] bg-gold-400 rounded-full blur-3xl" />
          </div>
